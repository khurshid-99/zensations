const PortfolioSection1 = () => {
  return (
    <div className="w-full  px-[5vw] pt-[5vw] flex items-center justify-between ">
      <section className="w-full">
        <h4 className="flex items-center">
          Our Portfolio{" "}
          <span className="inline-block w-[1.5rem] h-[1.2px] bg-black ml-2"></span>{" "}
        </h4>
        <h1 className="lg:text-[5vw] leading-0 lg:mt-[4vw] lg:mb-[1vw] ">
          Our Work
        </h1>
        <div className="w-full flex items-center justify-between pr-[5vw] ">
          <h1 className="lg:text-[5vw] font-bold ">Speaks for Itself</h1>
          <h4>
